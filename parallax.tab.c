...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GT_OP = 23,                     /* GT_OP  */
  YYSYMBOL_LT_OP = 24,                     /* LT_OP  */
...
{
       0,    67,    67,    73,    76,    82,    85,    88,    94,   100,
     103,   106,   112,   118,   121,   127,   133,   136,   139,   145,
     148,   151,   157,   160,   163,   169,   172,   175
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KEYWORD", "NUMBER", "BOOL", "LBRACE", "RBRACE", "LPAREN", "RPAREN",
  "COMMA", "SEMICOLON", "PLUS", "MINUS", "MULT", "DIV", "MOD", "AND_OP",
  "OR_OP", "EQ_OP", "NE_OP", "GT_OP", "LT_OP", "GE_OP", "LE_OP",
  "ADD_ASSIGN", "SUB_ASSIGN", "MUL_ASSIGN", "DIV_ASSIGN", "ASSIGN",
  "NOT_OP", "MOD_ASSIGN", "STRING", "$accept", "program", "statement_list",
  "statement", "function_definition", "parameter_list", "parameter",
  "function_body", "return_statement", "expression",
  "arithmetic_expression", "term", "factor", YY_NULLPTR
};
...
{
      -2,     5,     2,     3,     6,     3,    15,    -2,    -8,    -8,
      16,    19,    -3,     7,    -8,    11,    -8,    25,    -8,    -8,
      -8,    -8,     4,     4,     4,     4,    23,    -8,    -8,    -8,
       7,     7,    -8,    -8,    34,    14,    -8,    -8,    20,    23,
      -2,    -8,    -2,    29,    -8
};
...
{
       0,    26,     0,     0,    25,     0,     0,     2,     3,     5,
       0,     0,    16,    19,    22,     0,    15,     0,     1,     4,
       6,     7,     0,     0,     0,     0,     9,    27,    26,    25,
      20,    21,    23,    24,     0,     0,    10,    12,     0,     0,
      13,    11,    14,     0,     8
};
...
{
      19,     1,     2,     3,     4,    15,     1,    28,     5,     4,
      29,    22,    23,     5,     5,    18,   -17,   -18,   -17,   -18,
      16,    26,    17,    24,    25,    38,    39,    34,    40,    20,
      30,    31,    21,    32,    33,    19,    27,    37,    44,    42,
      41
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,     5,     6,     3,     3,     3,    10,     6,
       6,    14,    15,    10,    10,     0,    11,    11,    13,    13,
       3,    10,     5,    16,    17,    11,    12,     4,     8,    13,
      22,    23,    13,    24,    25,    42,    11,     3,     9,    40,
      39
};
...
{
       0,     3,     4,     5,     6,    10,    36,    37,    38,    39,
      43,    44,    45,    46,    47,     3,    44,    44,     0,    38,
      13,    13,    14,    15,    16,    17,    10,    11,     3,     6,
      46,    46,    47,    47,     4,    40,    41,     3,    11,    12,
       8,    41,    37,    42,     9
};
...
#line 1167 "parallax.tab.c"
    break;

  case 6: /* statement: return_statement SEMICOLON  */
#line 85 "parallax.y"
                                 {
        if(parsing_debug) print_parser_action("statement -> return_statement SEMICOLON");
    }
#line 1175 "parallax.tab.c"
    break;
...
#line 1183 "parallax.tab.c"
    break;

  case 8: /* function_definition: TYPE IDENTIFIER LPAREN parameter_list RPAREN LBRACE function_body RBRACE  */
#line 94 "parallax.y"
                                                                             {
...
#line 1223 "parallax.tab.c"
    break;

  case 13: /* function_body: %empty  */
#line 118 "parallax.y"
                {
        if(parsing_debug) print_parser_action("function_body -> (empty)");
    }
#line 1231 "parallax.tab.c"
    break;
...
#line 1239 "parallax.tab.c"
    break;

  case 15: /* return_statement: KEYWORD expression  */
#line 127 "parallax.y"
                       {
        if(parsing_debug) print_parser_action("return_statement -> KEYWORD expression");
    }
#line 1247 "parallax.tab.c"
    break;
...
#line 1271 "parallax.tab.c"
    break;

  case 19: /* arithmetic_expression: term  */
#line 145 "parallax.y"
         {
        if(parsing_debug) print_parser_action("arithmetic_expression -> term");
    }
#line 1279 "parallax.tab.c"
    break;
...
#line 1343 "parallax.tab.c"
    break;


#line 1347 "parallax.tab.c"
